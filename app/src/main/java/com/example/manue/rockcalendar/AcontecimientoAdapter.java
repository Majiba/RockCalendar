...
/**
 * Created by manue on 19/02/2018.
 */
    ...
    public class AcontecimientoAdapter
        ...
        public static class AcontecimientoViewHolder
            ...
            public AcontecimientoViewHolder(View itemView) {
                super(itemView);
                TextView_nombre = (TextView) itemView.findViewById(R.id.tvNombreAcon);
                TextView_inicio = (TextView) itemView.findViewById(R.id.tvInicioAcon);
            }
